...
abstract ${capitalizedName}_${name}(Sprite) from Sprite to Sprite {
    ...
    public static inline function create(layer:$capitalizedName):${capitalizedName}_${name} {
        ...
        var layer = '
@:forward(x, y, scaleX, scaleY, rotation, alpha, dispose, pause, mouse, base, width, height, getAllNames, update, create, add, remove, addRender, removeRender, addMouseDown, removeMouseDown, addMouseUp, removeMouseUp)
