...
@:forward(x, y, scaleX, scaleY, rotation, alpha, dispose, addRender, removeRender, addMouseDown, removeMouseDown, addMouseUp, removeMouseUp, mouse, base, loadBytes, reload, update, getAllNames, width, height)
