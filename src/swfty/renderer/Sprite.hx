...
@:forward(x, y, scaleX, scaleY, rotation, alpha, visible, loaded, width, height, exists, calcBounds, bounds, getIndex, addRender, removeRender, setBounds, setIndex, debug)
